...
import com.example.firebase23041909.databinding.ActivityPictureBinding
...
class PictureActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //firebase 실시간 데이터베이스에서 pictureData 로딩하고, 스토리지에서 이미지로딩
        pictureDataLoading()
    ...
    private fun pictureDataLoading() {
        ...
        pictureDAO.picutreSelect()?.addValueEventListener(object: ValueEventListener{
