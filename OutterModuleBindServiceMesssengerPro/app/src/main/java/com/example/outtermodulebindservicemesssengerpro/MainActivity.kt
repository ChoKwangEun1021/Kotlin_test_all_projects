package com.example.outtermodulebindservicemesssengerpro
...
import com.example.outtermodulebindservicemesssengerpro.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //1-2 receiveMessenger 생성하기(10번이 돌아오면 프로그래스바를 진행하고,
        //서비스 메세지 20 보내고, 서비스를 취소하고, 코루틴을 종료한다)
        ...
        //4. 정지버튼을 누르면 20 서비스에 전송하고 노래를 정지하고, bindservice를 종료하고, 코루틴 종료
